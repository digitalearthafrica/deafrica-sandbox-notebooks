...
def map_shapefile(
    ...
    **style_kwargs :
    ...
    elif hover_col and (isinstance(hover_col, str)):
    ...
    if linefeatures:
        ...
        for i in keys:
            choropleth.data["features"][i]["properties"]["style"]["color"] = choropleth.data[
                "features"
            ][i]["properties"]["style"]["fillColor"]
    ...
    if "CGLS" in product:
        try:
            labels = {
                ...
                40: {
                    "color": "#F096FF",
                    "flag": "cultivated_and_managed_vegetation_or_agriculture",
                },
                ...
                116: {
                    "color": "#007800",
                    "flag": "closed_forest_not_matching_any_of_the_other_definitions",
                },
                ...
                126: {
                    "color": "#648C00",
                    "flag": "open_forest_not_matching_any_of_the_other_definitions",
                },
            ...
            ticks = list(
                np.mean((list(list(labels.keys()) + [201])[i + 1], val))
    ...
    if "CCI" in product:
        try:
            labels = {
                ...
                180: {
                    "color": "#44eba9",
                    "flag": "shrub or herbaceous cover, flooded, fresh/saline/brakish water",
                },
            ...
            colors = [label["color"] for label in labels.values()]  # noqa F841
            cmap = ListedColormap([label["color"] for label in labels.values()])
