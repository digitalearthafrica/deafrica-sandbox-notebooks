...
def run_filmstrip_app(
    ...
    geopolygon = select_on_a_map(
        height="600px", layers=(basemap,), center=centre_coords, zoom=14
    )
    ...
    if area > size_limit:
        ...
        crs = mostcommon_crs(
            ...
            query={"time": "1990", "geopolygon": geopolygon},
        )
        ...
        if tide_range != (0.0, 1.0):
            ...
            ds = ds.sel(
                time=(ds.tide_height >= min_tide) & (ds.tide_height <= max_tide)
            )
