...
def random_sampling(
    da, n, min_sample_n=5, min_threshold_prop=0.05, sampling="stratified_random", manual_class_ratios=None, out_fname=None
):
    ...
    if sampling == "stratified_random":
        ...
        for _class in class_ratio["class"]:
            ...
            class_proportion = class_ratio[class_ratio["class"] == _class]["proportion"].values[0]
