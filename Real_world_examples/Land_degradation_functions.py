## Land_degradation_functions.py
'''
Description: This file contains a set of python functions for the Land_degradation notebook
...
def plot_possible_mining(ds, vegetation_loss_sum, water_frequency_sum, plot_filename="Possible_Mining.png"):
